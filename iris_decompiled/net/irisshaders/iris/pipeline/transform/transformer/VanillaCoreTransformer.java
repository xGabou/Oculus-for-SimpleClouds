...
public class VanillaCoreTransformer {
    public static void transform(ASTParser t, TranslationUnit tree, Root root, VanillaParameters parameters) {
        ...
        CommonTransformer.addIfNotExists(root, t, tree, "iris_TextureMat", Type.F32MAT4X4, StorageQualifier.StorageType.UNIFORM);
        CommonTransformer.addIfNotExists(root, t, tree, "iris_ProjMat", Type.F32MAT4X4, StorageQualifier.StorageType.UNIFORM);
        CommonTransformer.addIfNotExists(root, t, tree, "iris_ProjMatInverse", Type.F32MAT4X4, StorageQualifier.StorageType.UNIFORM);
        CommonTransformer.addIfNotExists(root, t, tree, "iris_ModelViewMat", Type.F32MAT4X4, StorageQualifier.StorageType.UNIFORM);
        CommonTransformer.addIfNotExists(root, t, tree, "iris_ModelViewMatInverse", Type.F32MAT4X4, StorageQualifier.StorageType.UNIFORM);
        root.rename("normalMatrix", "iris_NormalMat");
        root.rename("gl_NormalMatrix", "iris_NormalMat");
        CommonTransformer.addIfNotExists(root, t, tree, "iris_NormalMat", Type.F32MAT3X3, StorageQualifier.StorageType.UNIFORM);
        root.rename("chunkOffset", "iris_ChunkOffset");
        CommonTransformer.addIfNotExists(root, t, tree, "iris_ChunkOffset", Type.F32VEC3, StorageQualifier.StorageType.UNIFORM);
        ...
        if (parameters.type == PatchShaderType.VERTEX) {
            ...
            CommonTransformer.addIfNotExists(root, t, tree, "iris_ColorModulator", Type.F32VEC4, StorageQualifier.StorageType.UNIFORM);
            CommonTransformer.addIfNotExists(root, t, tree, "iris_Position", Type.F32VEC3, StorageQualifier.StorageType.IN);
            CommonTransformer.addIfNotExists(root, t, tree, "iris_Normal", Type.F32VEC3, StorageQualifier.StorageType.IN);
            CommonTransformer.addIfNotExists(root, t, tree, "iris_UV0", Type.F32VEC2, StorageQualifier.StorageType.IN);
            CommonTransformer.addIfNotExists(root, t, tree, "iris_UV1", Type.F32VEC2, StorageQualifier.StorageType.IN);
            CommonTransformer.addIfNotExists(root, t, tree, "iris_UV2", Type.F32VEC2, StorageQualifier.StorageType.IN);
        }
    }
}
