...
public class ModuloAssignmentExpression
extends BinaryExpression {
    ...
    public Expression.ExpressionType getExpressionType() {
        return Expression.ExpressionType.MODULO_ASSIGNMENT;
    }
    ...
    public ModuloAssignmentExpression clone() {
        return new ModuloAssignmentExpression(ModuloAssignmentExpression.clone(this.left), ModuloAssignmentExpression.clone(this.right));
    }
