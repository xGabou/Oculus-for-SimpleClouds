...
extends BinaryExpression {
    ...
    public Expression.ExpressionType getExpressionType() {
        return Expression.ExpressionType.ARRAY_ACCESS;
    }
    ...
    public ArrayAccessExpression clone() {
        return new ArrayAccessExpression(ArrayAccessExpression.clone(this.left), ArrayAccessExpression.clone(this.right));
    }
