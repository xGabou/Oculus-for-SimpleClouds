...
extends BinaryExpression {
    ...
    public Expression.ExpressionType getExpressionType() {
        return Expression.ExpressionType.SHIFT_RIGHT;
    }
    ...
    public RightShiftExpression clone() {
        return new RightShiftExpression(RightShiftExpression.clone(this.left), RightShiftExpression.clone(this.right));
    }
