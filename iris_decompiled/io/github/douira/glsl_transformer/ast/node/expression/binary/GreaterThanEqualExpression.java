...
extends BinaryExpression {
    ...
    public Expression.ExpressionType getExpressionType() {
        return Expression.ExpressionType.GREATER_THAN_EQUAL;
    }
    ...
    public GreaterThanEqualExpression clone() {
        return new GreaterThanEqualExpression(GreaterThanEqualExpression.clone(this.left), GreaterThanEqualExpression.clone(this.right));
    }
