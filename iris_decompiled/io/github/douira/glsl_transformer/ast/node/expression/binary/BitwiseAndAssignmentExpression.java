...
public class BitwiseAndAssignmentExpression
extends BinaryExpression {
    ...
    public Expression.ExpressionType getExpressionType() {
        return Expression.ExpressionType.BITWISE_AND_ASSIGNMENT;
    }
    ...
    public BitwiseAndAssignmentExpression clone() {
        return new BitwiseAndAssignmentExpression(BitwiseAndAssignmentExpression.clone(this.left), BitwiseAndAssignmentExpression.clone(this.right));
    }
