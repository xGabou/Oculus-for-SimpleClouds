...
public class InteriorCloudConfig {
    ...
    public static final ModConfigSpec.BooleanValue SUPPRESS_MESH;
    public static final ModConfigSpec.BooleanValue SUPPRESS_TRANSPARENT_MESH;
    public static final ModConfigSpec.BooleanValue MODIFY_FOG;
    public static final ModConfigSpec.BooleanValue MODIFY_FOG_COLOR;
    public static final ModConfigSpec.DoubleValue MESH_SUPPRESSION_THRESHOLD;
    ...
    public static final ModConfigSpec.DoubleValue VERTICAL_FADE_BLOCKS;
    public static final ModConfigSpec.DoubleValue MIN_HORIZONTAL_DENSITY;
    public static final ModConfigSpec.DoubleValue HORIZONTAL_DENSITY_POWER;
    public static final ModConfigSpec.DoubleValue COLOR_RED;
    public static final ModConfigSpec.DoubleValue COLOR_GREEN;
    public static final ModConfigSpec.DoubleValue COLOR_BLUE;
